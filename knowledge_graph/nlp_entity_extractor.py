...
class NLPEntityExtractor:
    ...
    def _setup_custom_patterns(self):
        ...
        tech_patterns = [
            ...
            [{"TEXT": {"IN": ["MySQL", "PostgreSQL", "MongoDB", "Redis", "SQLite"]}}],
            # Cloud and services
        ...
        concept_patterns = [
            ...
            [{"LOWER": {"IN": ["api", "rest", "graphql", "microservices", "devops"]}}],
            ...
            for entity2 in entities[i + 1 :]:
                ...
                if relationship_type:
                    relationship = Relationship(
                        source=entity1, target=entity2, type=relationship_type, confidence=0.7
                    )
