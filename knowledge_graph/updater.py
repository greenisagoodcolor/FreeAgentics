...
from knowledge_graph.extraction import ExtractionPipeline, ExtractionResult
...
from knowledge_graph.pymdp_extractor import (
    ...
    PyMDPEntityExtractor,
    PyMDPRelationExtractor,
)
...
class KnowledgeGraphUpdater:
    ...
    async def _process_single_update(self, request: UpdateRequest) -> Dict[str, Any]:
        ...
        try:
            ...
            if extraction_result.get("metadata", {}).get("error"):
                ...
                logger.error(f"Knowledge extraction failed: {extraction_result['metadata']['error']}")
            ...
            result = {
                **extraction_result,
                ...
                "processing_summary": {
                    ...
                    "extraction_time_ms": extraction_result["metadata"]["processing_time_seconds"] * 1000,
    ...
    def get_metrics(self) -> Dict[str, Any]:
        ...
        realtime_health = {
            ...
            "event_streamer_active": getattr(self.realtime_updater.event_streamer, "is_streaming", False),
