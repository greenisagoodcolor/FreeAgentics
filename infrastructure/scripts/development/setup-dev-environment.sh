...
print_next_steps() {
    ...
    echo -e "  1. Start development:     ${BLUE}make dev${NC}"
    echo -e "  2. Run all tests:         ${BLUE}make test-full${NC}"
    echo -e "  3. Check code quality:    ${BLUE}make quality${NC}"
    echo -e "  4. View all commands:     ${BLUE}make help${NC}"
    echo ""
    echo -e "${BOLD}Docker alternative:${NC}"
    echo -e "  Start with Docker:        ${BLUE}make dev-docker${NC}"
    echo ""
    echo -e "${BOLD}Troubleshooting:${NC}"
    echo -e "  Reset database:           ${BLUE}make db-reset${NC}"
    echo -e "  Clean build artifacts:    ${BLUE}make clean${NC}"
