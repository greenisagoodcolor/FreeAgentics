...
test.describe('Dashboard Visual Tests', () => {
  ...
  test('Dashboard Visual Regression Test', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="goal-panel"]')).toBeVisible({ timeout: 10000 });
    await expect(page.locator('[data-testid="agent-panel"]')).toBeVisible({ timeout: 10000 });
    await expect(page.locator('[data-testid="conversation-panel"]')).toBeVisible({ timeout: 10000 });
    await expect(page.locator('[data-testid="knowledge-panel"]')).toBeVisible({ timeout: 10000 });
    ...
    await expect(page.locator('[data-testid="knowledge-graph-svg"]')).toBeVisible({ timeout: 10000 });
  ...
  test('Dashboard Visual Regression Test - SVG Renders Correctly', async ({ page }) => {
    ...
    const knowledgeGraphSvg = page.locator('[data-testid="knowledge-graph-svg"]');
    ...
    await expect(knowledgeGraphSvg).toHaveScreenshot('knowledge-graph-svg.png', {
...
test.describe('Knowledge Graph Visual Tests', () => {
  ...
  test('knowledge graph animations work correctly', async ({ page }) => {
    ...
    await expect(page.locator('svg')).toHaveScreenshot('knowledge-graph-zoomed.png');
  ...
  test('filters apply visual changes', async ({ page }) => {
    ...
    await expect(page.locator('svg')).toHaveScreenshot('knowledge-graph-filtered.png');
