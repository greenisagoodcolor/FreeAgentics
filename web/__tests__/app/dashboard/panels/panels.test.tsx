  ...
  return (
    <div data-testid="agent-panel">
      ...
      <div className="panel-controls">
        <button onClick={() => console.log('Create agent')}>Create Agent</button>
    ...
    <div data-testid="analytics-panel">
      ...
      <div className="metrics-grid">
        ...
        <div className="metric-card">
          ...
          <span className="metric-value">{metrics?.activeConversations || 0}</span>
        </div>
        <div className="metric-card">
...
const ConversationPanel = ({ conversations, onStartConversation, onViewConversation }: any) => {
  return (
      ...
      <div className="conversation-list">
        {conversations?.map((conv: any) => (
          <div key={conv.id} className="conversation-item">
            ...
            <span className="participant-count">{conv.participants?.length || 0} participants</span>
  ...
  return (
    <div data-testid="visualization-panel">
      ...
      <div className="view-selector">
        <select value={viewType} onChange={(e) => onChangeView?.(e.target.value)}>
...
describe('Dashboard Panels', () => {
  describe('AgentPanel', () => {
    ...
    it('shows selected agent state', () => {
      ...
      const selectedItem = screen.getByText('Explorer Agent').closest('.agent-item');
  ...
  describe('ConversationPanel', () => {
    ...
    it('renders conversation list', () => {
      render(<ConversationPanel conversations={mockConversations} {...mockHandlers} />);
  ...
  describe('VisualizationPanel', () => {
    ...
    it('displays current view content', () => {
      ...
      expect(screen.getByText('timeline visualization with 3 data points')).toBeInTheDocument();
    });
    ...
    it('handles empty data gracefully', () => {
      ...
      expect(screen.getByText('network visualization with 0 data points')).toBeInTheDocument();
    });
  });
