...
describe('Unified Agent Type System', () => {
  ...
  describe('Validation Utilities', () => {
    ...
    it('should validate ManagementAgent correctly', () => {
      ...
      expect(() => AgentValidators.validateManagementAgent(invalidAgent)).toThrow('Invalid ManagementAgent object');
    });
    ...
    it('should validate PromptAgent correctly', () => {
      ...
      expect(() => AgentValidators.validatePromptAgent(invalidAgent)).toThrow('Invalid PromptAgent object');
    });
    ...
    it('should validate SimulationAgent correctly', () => {
      ...
      expect(() => AgentValidators.validateSimulationAgent(invalidAgent)).toThrow('Invalid SimulationAgent object');
    });
  });
  ...
  describe('Integration Scenarios', () => {
    ...
    it('should handle test mock data scenarios', () => {
      ...
      const mockPromptResponse = {
        agents: [AgentFactories.createPromptAgent({
          id: 'mock-1',
          name: 'Mock Agent',
          status: 'active',
        })],
