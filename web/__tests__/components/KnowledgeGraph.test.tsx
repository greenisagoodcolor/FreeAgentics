...
describe('KnowledgeGraph Component', () => {
  const mockKnowledge = [
    { id: '1', title: 'Node 1', content: 'Content 1', tags: ['tag1', 'tag2'], timestamp: new Date() },
    { id: '2', title: 'Node 2', content: 'Content 2', tags: ['tag2', 'tag3'], timestamp: new Date() },
    { id: '3', title: 'Node 3', content: 'Content 3', tags: ['tag1'], timestamp: new Date() },
  ];
  ...
  describe('Rendering', () => {
    it('renders without crashing', () => {
      render(<KnowledgeGraph knowledge={[]} onSelectEntry={() => {}} selectedEntry={null} />);
    ...
    it('displays knowledge entry count', () => {
      render(<KnowledgeGraph {...mockProps} />);
      expect(screen.getByText(`${mockKnowledge.length} entries`)).toBeInTheDocument();
    });
  ...
  describe('Interactions', () => {
    ...
    it('calls onSelectEntry when knowledge entry is clicked', () => {
      ...
      render(<KnowledgeGraph knowledge={mockKnowledge} onSelectEntry={onSelectEntry} selectedEntry={null} />);
  ...
  describe('Visual States', () => {
    it('highlights selected entry', () => {
      render(<KnowledgeGraph {...mockProps} selectedEntry={mockKnowledge[0]} />);
      expect(d3.select).toHaveBeenCalled();
    });
  ...
  describe('Performance', () => {
    it('handles large datasets efficiently', () => {
      ...
      render(<KnowledgeGraph knowledge={largeKnowledge} onSelectEntry={() => {}} selectedEntry={null} />);
      expect(d3.forceSimulation).toHaveBeenCalled();
    });
  ...
  describe('Error Handling', () => {
    it('handles invalid knowledge data gracefully', () => {
      const invalidKnowledge = [
        { id: null, title: 'Invalid', content: '', tags: [], timestamp: new Date() },
        { id: 'valid', title: 'Valid', content: 'Valid content', tags: ['tag'], timestamp: new Date() },
      ];

      render(<KnowledgeGraph knowledge={invalidKnowledge as any} onSelectEntry={() => {}} selectedEntry={null} />);
      expect(d3.select).toHaveBeenCalled();
    });
