...
const Alert = ({ variant = 'default', children, className = '', ...props }: any) => {
  const variantClasses = {
...
const TabsList = ({ children, className = '', activeTab, onTabChange, ...props }: any) => {
  return (
...
const TabsTrigger = ({ value, children, isActive, onClick, className = '', ...props }: any) => {
  return (
    <button
