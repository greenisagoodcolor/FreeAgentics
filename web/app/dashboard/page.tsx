...
export default function DashboardPage({}: DashboardPageProps) {
  ...
  const initialView =
    (searchParams?.get("view") as DashboardView) || "executive";
  ...
  return (
    ...
    >
      ...
      <div
        className="command-bar h-12 flex items-center justify-between px-6"
        style={{
            ...
            {(
              ...
              <button
                ...
                className={`button button-sm ${
                  currentView === view ? "button-primary" : "button-ghost"
                }`}
              >
