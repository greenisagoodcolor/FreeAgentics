...
interface ExportModalProps {
  ...
  conversations?: { id: string; participants: string[]; messageCount: number }[];
}
...
export function ExperimentExportModal({
  ...
  const handleConversationToggle = (conversationId: string) => {
    setExportOptions(prev => {
      const selectedConversationIds = prev.selectedConversationIds.includes(conversationId)
  ...
  const handleSelectAllAgents = () => {
    setExportOptions(prev => ({
      ...prev,
      selectedAgentIds: prev.selectedAgentIds.length === agents.length ? [] : agents.map(a => a.id)
    }));
  };
  ...
  const handleSelectAllConversations = () => {
    setExportOptions(prev => ({
      ...prev,
      selectedConversationIds: prev.selectedConversationIds.length === conversations.length 
        ? [] 
  ...
  const renderConfigStep = () => (
    <>
      <DialogHeader>
        ...
        <DialogDescription>
          Export your experiment state for reproducible research, collaboration, or backup.
        </DialogDescription>
      </DialogHeader>
          ...
          <div className="grid grid-cols-2 gap-4 pt-1">
            <div className="flex items-center space-x-2">
              <Checkbox 
                ...
                onCheckedChange={(checked) => 
                  setExportOptions({...exportOptions, includeAgents: !!checked})
                }
              />
              <div className="grid gap-1.5">
                <Label htmlFor="include-agents" className="flex items-center gap-1">
            ...
            <div className="flex items-center space-x-2">
              <Checkbox 
                ...
                onCheckedChange={(checked) => 
                  setExportOptions({...exportOptions, includeConversations: !!checked})
                }
              />
              <div className="grid gap-1.5">
                <Label htmlFor="include-conversations" className="flex items-center gap-1">
            ...
            <div className="flex items-center space-x-2">
              <Checkbox 
                ...
                onCheckedChange={(checked) => 
                  setExportOptions({...exportOptions, includeKnowledgeGraphs: !!checked})
                }
              />
              <div className="grid gap-1.5">
                <Label htmlFor="include-knowledge" className="flex items-center gap-1">
            ...
            <div className="flex items-center space-x-2">
              <Checkbox 
                ...
                onCheckedChange={(checked) => 
                  setExportOptions({...exportOptions, includeCoalitions: !!checked})
                }
              />
              <div className="grid gap-1.5">
                <Label htmlFor="include-coalitions" className="flex items-center gap-1">
            ...
            <div className="flex items-center space-x-2">
              <Checkbox 
                ...
                onCheckedChange={(checked) => 
                  setExportOptions({...exportOptions, includeInferenceModels: !!checked})
                }
              />
              <div className="grid gap-1.5">
                <Label htmlFor="include-inference" className="flex items-center gap-1">
            ...
            <div className="flex items-center space-x-2">
              <Checkbox 
                ...
                onCheckedChange={(checked) => 
                  setExportOptions({...exportOptions, includeWorldState: !!checked})
                }
              />
              <div className="grid gap-1.5">
                <Label htmlFor="include-world" className="flex items-center gap-1">
            ...
            <div className="flex items-center space-x-2">
              <Checkbox 
                ...
                onCheckedChange={(checked) => 
                  setExportOptions({...exportOptions, includeParameters: !!checked})
                }
              />
              <div className="grid gap-1.5">
                <Label htmlFor="include-parameters" className="flex items-center gap-1">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <div className="grid gap-1.5">
                <Label htmlFor="compression" className="flex items-center gap-1">
        ...
        {exportOptions.includeAgents && agents.length > 0 && (
          <div className="grid gap-2 pt-2">
            <div className="flex items-center justify-between">
              ...
              >
                {exportOptions.selectedAgentIds.length === agents.length ? "Deselect All" : "Select All"}
              </Button>
            </div>
            ...
            <div className="max-h-40 overflow-y-auto border rounded-md p-2">
              {agents.map(agent => (
                <div key={agent.id} className="flex items-center space-x-2 py-1">
                  ...
                  />
                  <Label htmlFor={`agent-${agent.id}`} className="flex items-center gap-2 cursor-pointer">
          ...
          <div className="grid gap-2 pt-2">
            <div className="flex items-center justify-between">
              ...
              <Button 
                ...
                className="h-7 text-xs"
              >
                {exportOptions.selectedConversationIds.length === conversations.length ? "Deselect All" : "Select All"}
              </Button>
            </div>
            
            <div className="max-h-40 overflow-y-auto border rounded-md p-2">
              {conversations.map(conversation => (
                <div key={conversation.id} className="flex items-center space-x-2 py-1">
                  <Checkbox 
                    id={`conversation-${conversation.id}`} 
                    checked={exportOptions.selectedConversationIds.includes(conversation.id)}
                    onCheckedChange={() => handleConversationToggle(conversation.id)}
                  />
                  <Label htmlFor={`conversation-${conversation.id}`} className="flex items-center gap-2 cursor-pointer">
                    <span>Conversation {conversation.id.substring(0, 8)}</span>
                    <span className="text-xs text-muted-foreground">
                      ({conversation.messageCount} messages, {conversation.participants.length} participants)
                    </span>
                  </Label>
                </div>
              ))}
