...
export async function GET(request: NextRequest) {
  return NextResponse.json({
    models: [
      {
        ...
        description: 'Classic GNN architecture that aggregates neighbor features through spectral graph convolutions',
      ...
      },
      {
        ...
        description: 'Uses attention mechanisms to learn different weights for different neighbors',
      ...
      },
      {
        id: 'sage',
        name: 'GraphSAGE',
        description: 'Inductive learning framework that samples and aggregates neighbor features',
        tasks: ['node_classification', 'graph_classification', 'link_prediction'],
        parameters: {
          hidden_dims: {
            type: 'array',
      ...
      },
      {
        ...
        description: 'Maximally expressive GNN architecture based on the Weisfeiler-Lehman test',
    ...
    autoSelection: {
      description: 'When architecture is set to "auto", the system selects the best model based on:',
      criteria: [
