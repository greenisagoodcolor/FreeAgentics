...
export async function GET(
  ...
  try {
    ...
    try {
      ...
      const sharingData = {
        sharedLinks: type === 'all' || type === 'links' ? [
          {
            id: 'link_001',
            url: `https://freeagentics.com/shared/${experimentId}/view?token=abc123def456`,
            name: 'Research Team Access',
            description: 'Shared with research team for collaborative analysis',
        ...
        versions: type === 'all' || type === 'versions' ? [
          {
            id: 'v1.0.0',
            name: 'Initial Export',
            createdAt: '2024-01-15T10:30:00Z',
        ...
        changeLog: type === 'all' || type === 'changelog' ? [
          {
            id: 'change_001',
