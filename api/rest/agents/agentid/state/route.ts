...
const UpdateStateSchema = z.object({
  status: z.enum(['idle', 'moving', 'interacting', 'planning', 'executing', 'learning', 'error', 'offline']),
...
export async function PUT(
  ...
  try {
    ...
    const validTransitions: Record<string, string[]> = {
      ...
      executing: ['idle', 'moving', 'interacting', 'planning', 'offline', 'error'],
    ...
    const isValidTransition = validTransitions[currentState]?.includes(status) || force
