...
export async function GET(
  ...
  try {
    ...
    const mockAgent = {
      ...
      beliefs: [
        { id: 'belief-1', content: 'Resource at location (15, 25)', confidence: 0.8 },
        { id: 'belief-2', content: 'Safe zone at location (0, 0)', confidence: 0.95 }
      ],
      goals: [
        { id: 'goal-1', description: 'Explore unknown areas', priority: 0.7, deadline: null },
        { id: 'goal-2', description: 'Find resources', priority: 0.9, deadline: '2025-06-19T00:00:00Z' }
      ],
      relationships: [
        { agent_id: 'agent-2', trust_level: 0.8, last_interaction: '2025-06-18T12:00:00Z' }
      ],
