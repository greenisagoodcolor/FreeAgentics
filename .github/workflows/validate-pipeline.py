...
class PipelineValidator:
    ...
    REQUIRED_STAGES = ["pre-flight", "quality", "security", "test", "build"]
    ...
    def _check_bypass_mechanisms(
        self, workflow: Dict, workflow_name: str, workflow_file: Path
    ) -> None:
    ...
    def _check_required_stages(self, workflow: Dict, workflow_name: str) -> None:
        ...
        for required_check in self.REQUIRED_CHECKS:
            if not any(
                required_check.replace("-", "_") in job_name.replace("-", "_")
