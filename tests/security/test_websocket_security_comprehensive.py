...
from websocket.auth_handler import WebSocketAuthHandler, WebSocketErrorCode, ws_auth_handler
...
class TestWebSocketPerformance:
    ...
    async def test_message_handling_performance(self):
        ...
        for i in range(1000):
            msg = WebSocketMessage(type="update", data={"index": i, "message": f"Test message {i}"})
