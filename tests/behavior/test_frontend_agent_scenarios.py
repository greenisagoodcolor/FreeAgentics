...
class TestFrontendAgentBehavior:
    ...
    def test_belief_propagation_visualization(self):
        ...
        result = self._run_frontend_test("belief-propagation", belief_network)
    ...
    def test_learning_curve_visualization(self):
        ...
        result = self._run_frontend_test("learning-curves", learning_scenario)
    ...
    def test_swarm_behavior_visualization(self):
        ...
        result = self._run_frontend_test("swarm-behavior", swarm_scenario)
    ...
    def _run_frontend_test(self, test_name: str, test_scenario: dict) -> dict:
        """
        ...
        test_config = {"test": test_name, "scenario": test_scenario}
