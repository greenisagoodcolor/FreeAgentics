...
class E2ETestRunner:
    ...
    def run_tests(self, 
                  ...
                  suite_name: str = "e2e_tests") -> Dict[str, Any]:
        """
        ...
        try:
            ...
            self.collector.start_suite(suite_name, {
        ...
        try:
            ...
            for future in as_completed(future_to_test):
                ...
                try:
                    ...
                    if self.fail_fast and result.status in ["failed", "error"]:
                        logger.info(f"Fail-fast enabled, cancelling remaining tests after {test_name} failure")
...
def run_single_test(test_func: Callable, 
    ...
    return TestResult(
        test_name=test_name,
        status="error",
        error_message="Failed to retrieve test result"
    )


def run_test_suite(test_funcs: Dict[str, Callable],
