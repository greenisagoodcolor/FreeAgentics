...
class TestMessageQueueIsolation:
    ...
    def mq_isolation(self):
        ...
        return MessageQueueIsolation(
            host="localhost", port=5672, user="test_user", password="test_password"
        )
...
class TestFilesystemIsolation:
    ...
    def test_cleanup_sandbox(self, fs_isolation):
        ...
        with patch("shutil.rmtree") as mock_rmtree:
            ...
            mock_rmtree.assert_called_with("/tmp/test_sandbox", ignore_errors=True)
        ...
        with patch("shutil.copytree") as mock_copytree:
            with patch("shutil.copy2") as mock_copy2:
                with patch("os.path.isdir") as mock_isdir:
                    ...
                    mock_copy2.assert_called_with("/source/file.txt", Path("/tmp/sandbox/dest.txt"))
...
class TestTestIsolation:
    ...
    def test_isolation(self):
        ...
        config = {
            ...
            "rabbitmq": {"host": "localhost", "port": 5672, "user": "test", "password": "test"},
        }
