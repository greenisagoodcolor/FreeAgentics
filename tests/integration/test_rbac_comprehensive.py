...
from auth.security_implementation import (
    UserRole, Permission, ROLE_PERMISSIONS, auth_manager, TokenData
)
from auth.rbac_enhancements import (
    enhanced_rbac_manager, AccessContext, ResourceContext, 
    ABACRule, ABACEffect, RoleAssignmentRequest, RequestStatus
)
from auth.resource_access_control import (
    ResourceAccessValidator, require_resource_access, require_ownership
)
...
class TestABACFunctionality:
    ...
    def test_abac_access_evaluation(self):
        ...
        observer_access, observer_reason, observer_rules = enhanced_rbac_manager.evaluate_abac_access(
...
class TestResourceAccessControl:
    ...
    def test_resource_access_decorator(self):
        ...
        with patch('auth.resource_access_control.ResourceAccessValidator.validate_agent_access') as mock_validate:
    ...
    def test_ownership_decorator(self):
...
class TestSecurityIntegration:
    ...
    def test_rate_limiting_integration(self):
        ...
        # Check log entry
        rate_limit_entries = [
            entry for entry in comprehensive_auditor.decision_log
