...
class TestBasicIntegration:
    ...
    def test_discrete_inference_cycle(self) -> None:
        ...
        for t in range(10):
            ...
            policy_selector.compute_expected_free_energy(test_policy, belief, gen_model)
...
class TestFullSystemIntegration:
    ...
    def test_complete_agent_simulation(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            _ = ActiveLearningAgent(active_config, gen_model, inference, policy_selector)
...
class TestActiveInferenceIntegration:
    ...
    def test_belief_evolution(self, agent, components, ai_config) -> None:
        ...
        assert any(change > 1e-6 for change in belief_changes), "Beliefs should evolve over time"
