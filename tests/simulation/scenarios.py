...
from tests.simulation.user_personas import ActivityLevel, InteractionPattern, PersonaType
...
class SimulationScenarios:
    ...
    def burst_activity() -> SimulationConfig:
        ...
        return SimulationConfig(
            ...
            network_latency_range=(0.001, 0.01),  # Low latency for burst response
        )
    ...
    @staticmethod
    def create_custom(
        name: str, duration_seconds: float, user_counts: Dict[str, int], **kwargs
    ) -> SimulationConfig:
