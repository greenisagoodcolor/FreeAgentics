...
from agents.base_agent import AgentConfig, ActiveInferenceAgent
...
class TestAgentErrorHandling:
    ...
    def test_handle_agent_creation_error(self, agent_with_errors):
        ...
        with patch.object(manager, '_create_agent_instance', side_effect=Exception("Creation failed")):
            # Act
    ...
    def test_recover_from_processing_error(self, agent_with_errors):
        ...
        with patch.object(agent, 'process_observation', side_effect=Exception("Process error")):
            ...
            result = manager.handle_observation(agent_id, {"type": "test", "data": {}})
...
class TestAgentSecurity:
    ...
    def test_agent_isolation(self, secure_manager):
        ...
        result1 = secure_manager.handle_observation(agent1_id, obs)
    ...
    def test_resource_exhaustion_protection(self, secure_manager):
        ...
        huge_obs = {
            "type": "process",
            "data": {"array": [0] * 10_000_000}  # 10M elements
        }
