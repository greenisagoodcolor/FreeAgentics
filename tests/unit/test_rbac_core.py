...
from auth.security_implementation import (
    UserRole, Permission, ROLE_PERMISSIONS, User, TokenData, 
    SecurityValidator, AuthenticationManager
)
from auth.rbac_enhancements import (
    ABACRule, ABACEffect, AccessContext, ResourceContext, 
    RoleAssignmentRequest, RequestStatus, EnhancedRBACManager
)
...
class TestRolePermissionMatrix:
    ...
    def test_sensitive_permissions_restricted(self):
        ...
        for perm in admin_only_perms:
            ...
            assert roles_with_perm == [UserRole.ADMIN], f"Permission {perm} should only be granted to admin"
