...
def test_import_all_modules():
    ...
    # Import submodules
    from agents import base_agent, error_handling, performance_optimizer, pymdp_error_handling
    ...
    from knowledge_graph import storage, query, evolution
...
def test_execute_simple_functions():
    ...
    from agents.error_handling import ErrorSeverity, AgentError, PyMDPError
    ...
    # Test GMN classes
    from inference.active.gmn_parser import GMNNode, GMNEdge, GMNGraph
...
def test_observability_functions():
    ...
    from observability import record_belief_update, monitor_pymdp_inference
...
def test_tools_module():
    """Test tools module."""
    from tools.performance_documentation_generator import PerformanceDocGenerator
