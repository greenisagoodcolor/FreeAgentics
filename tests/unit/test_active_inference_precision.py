...
class TestGradientPrecisionOptimizer:
    ...
    def test_optimize_precision_1d_errors(self):
        ...
        assert self.optimizer.error_history[0].shape == (3,)  # GradientPrecisionOptimizer stores 1D errors
...
class TestMetaLearningPrecisionOptimizer:
    ...
    def test_initialization(self):
        ...
        max_input_dim = self.num_modalities * 3 + self.input_dim  # error features (mean+std+max per modality) + context
