...
def test_functional_world_classes():
    ...
    config = SimulationConfig(
        ...
        agents={"count": 10, "distribution": {"explorer": 4, "merchant": 3, "scholar": 2, "guardian": 1}},
    )
...
def test_functional_inference_classes():
    ...
    from inference.engine.generative_model import GenerativeModel  # noqa: F401
    ...
    print(f"✓ DiscreteGenerativeModel works: observation shape = {obs_probs.shape}")
