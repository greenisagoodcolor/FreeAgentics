    ...
    def test_upload_large_gmn_specification(self, client, agent_id):
        ...
        large_spec = {
            ...
            "specification": {
                ...
                "edges": [
                    {"from": "location", "to": "obs_location", "type": "generates"},
                    {"from": "goal_pref", "to": "obs_location", "type": "depends_on"},
                ],
            },
        }
...
class TestGMNAPIEndpointGET:
    ...
    def test_list_gmn_specifications_for_agent(self, client, agent_id):
        ...
        with patch("database.gmn_repository.GMNRepository") as mock_repo:
            ...
            mock_specs = [
                Mock(id=uuid.uuid4(), name="Spec 1", version="1.0", is_active=True),
                Mock(id=uuid.uuid4(), name="Spec 2", version="1.1", is_active=False),
            ]
