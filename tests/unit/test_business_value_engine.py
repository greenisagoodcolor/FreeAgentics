...
class TestBusinessValueCalculationEngine:
    ...
    def test_calculate_business_value_success(self, mock_logger, engine, mock_coalition, 
    ...
    def test_calculate_business_value_empty_profiles(self, engine, mock_coalition, 
        ...
        assert result.operational_efficiency == 0.0
        assert result.innovation_potential == 0.0
        # Market positioning and sustainability may still have some value from formation result
        assert result.market_positioning >= 0.0
        assert result.sustainability_score >= 0.0
        assert result.total_value >= 0.0
        assert result.confidence_level >= 0.0
    ...
    def test_calculate_synergy_empty_profiles(self, engine, mock_coalition, mock_formation_result_success):
    ...
    def test_calculate_synergy_with_profiles(self, engine, mock_coalition, 
                                           mock_formation_result_success, mock_agent_profiles):
        """Test synergy calculation with agent profiles"""
        result = engine._calculate_synergy(mock_coalition, mock_formation_result_success, mock_agent_profiles)
    ...
    def test_calculate_synergy_zero_individual_value(self, engine, mock_coalition, 
                                                   mock_formation_result_success):
        ...
        result = engine._calculate_synergy(mock_coalition, mock_formation_result_success, zero_profiles)
        assert result == 0.0
    ...
    def test_calculate_risk_reduction_with_profiles(self, engine, mock_coalition, mock_agent_profiles):
    ...
    def test_calculate_market_positioning_various_strategies(self, engine, mock_coalition):
        ...
        strategies = [
            "active_inference", "capability_based", "resource_optimization",
            "preference_matching", "stability_maximization", "business_opportunity", "unknown"
        ]
    ...
    def test_calculate_market_positioning_with_context(self, engine, mock_coalition, mock_formation_result_success):
        """Test market positioning with market context"""
        market_context = {"readiness_score": 0.9}
        
        result = engine._calculate_market_positioning(mock_coalition, mock_formation_result_success, market_context)
    ...
    def test_calculate_market_positioning_speed_bonus(self, engine, mock_coalition):
        ...
        fast_result.strategy_used.value = "preference_matching"  # Lower base score (0.6)
        ...
        slow_result.strategy_used.value = "preference_matching"  # Lower base score (0.6)
    ...
    def test_calculate_sustainability_empty_profiles(self, engine, mock_coalition, mock_formation_result_success):
    ...
    def test_calculate_sustainability_with_profiles(self, engine, mock_coalition, 
                                                  mock_formation_result_success, mock_agent_profiles):
        """Test sustainability calculation with agent profiles"""
        result = engine._calculate_sustainability(mock_coalition, mock_formation_result_success, mock_agent_profiles)
        
        assert isinstance(result, float)
        assert 0.0 <= result <= 1.0
        assert result > 0.0

    def test_calculate_sustainability_failed_formation(self, engine, mock_coalition, 
                                                     mock_formation_result_failure, mock_agent_profiles):
        """Test sustainability calculation with failed formation"""
        result = engine._calculate_sustainability(mock_coalition, mock_formation_result_failure, mock_agent_profiles)
    ...
    def test_calculate_operational_efficiency_with_profiles(self, engine, mock_coalition, mock_agent_profiles):
    ...
    def test_calculate_innovation_potential_with_profiles(self, engine, mock_coalition, mock_agent_profiles):
    ...
    def test_calculate_confidence_with_profiles(self, engine, mock_formation_result_success, mock_agent_profiles):
    ...
    def test_calculate_confidence_failed_formation(self, engine, mock_formation_result_failure, mock_agent_profiles):
    ...
    def test_get_calculation_history_with_data(self, engine, mock_coalition, 
                                              mock_formation_result_success, mock_agent_profiles):
        """Test getting calculation history with data"""
        # Perform several calculations
        for i in range(5):
            engine.calculate_business_value(mock_coalition, mock_formation_result_success, mock_agent_profiles)
    ...
    def test_mathematical_consistency(self, engine, mock_coalition, 
                                    mock_formation_result_success, mock_agent_profiles):
        ...
        for i in range(1, len(results)):
            ...
            assert abs(results[0].operational_efficiency - results[i].operational_efficiency) < 0.0001
