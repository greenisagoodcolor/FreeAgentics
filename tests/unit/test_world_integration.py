...
class TestActionResult:
    ...
    def test_action_result_defaults(self):
        ...
        result = ActionResult(success=True, action_type=ActionType.OBSERVE)
...
class TestWorldEventSystem:
    ...
    def test_publish_event_with_affected_agents(self):
        ...
        # Called because agent_1 is event.agent_id
        callback1.assert_called_once_with(event)
        # Called because agent_2 is in affected_agents
        callback2.assert_called_once_with(event)
    ...
    def test_get_recent_events_different_location(self):
        ...
        event1 = WorldEvent(event_type=EventType.AGENT_MOVED, location="hex_1")
        event2 = WorldEvent(event_type=EventType.AGENT_MOVED, location="hex_2")
...
class TestAgentWorldManager:
    ...
    def test_perform_harvest_action_resource_not_available(self):
        ...
        result = self.manager.perform_action(
            "agent_1", ActionType.HARVEST_RESOURCE, {"resource_type": "gold"}
        )
