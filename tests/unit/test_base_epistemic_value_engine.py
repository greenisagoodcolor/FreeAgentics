...
class TestEpistemicValueCalculationEngine:
    ...
    def test_network_entropy_calculation(self):
        ...
        expected = (self.engine.agent_states["agent_1"].knowledge_entropy + 
                   self.engine.agent_states["agent_2"].knowledge_entropy) / 2
    ...
    def test_network_stability(self):
        ...
        # With moderate variance in consensus, stability should still be high but not perfect
        assert stability < 1.0
