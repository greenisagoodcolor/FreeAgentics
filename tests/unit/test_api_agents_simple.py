...
class TestAgentEndpoints:
    ...
    def test_create_agent_endpoint_exists(self, client, sample_agent_config):
        ...
        assert response.status_code in [200, 201, 422, 500], "Should return a valid HTTP status"
    ...
    def test_get_agents_endpoint_exists(self, client):
        ...
        assert response.status_code in [200, 500], "Should return a valid HTTP status"
    ...
    def test_get_single_agent_endpoint_exists(self, client):
        ...
        assert response.status_code in [200, 404, 500], "Should return a valid HTTP status"
    ...
    def test_delete_agent_endpoint_exists(self, client):
        ...
        assert response.status_code in [200, 204, 404, 500], "Should return a valid HTTP status"
    ...
    def test_create_conversation_endpoint_exists(self, client):
        ...
        conversation_data = {"prompt": "Hello, test agent!", "provider": "ollama", "context": {}}
