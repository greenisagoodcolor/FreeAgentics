...
class TestDiscreteExpectedFreeEnergyPyMDP:
    ...
    def test_pymdp_multi_step_policy_evaluation(self, pymdp_compatible_model):
        ...
        config = PolicyConfig(
            planning_horizon=3,
            policy_length=2,  # 2-step policies
            use_gpu=False
        )
        ...
        class LLMGeneratedPyMDPModel:
            def __init__(self):
                ...
                self.gnn_metadata = {
                    ...
                    "observation_semantics": ["clear_path", "person_present", "destination_reached"],
                    "llm_generated": True,
