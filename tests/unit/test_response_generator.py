...
class TestProductionResponseGenerator:
    ...
    async def test_generate_response_complete_failure_with_fallback(
        ...
        generator.formatter.format_response = AsyncMock(
        ...
        with patch.object(generator, '_generate_fallback_response', 
                         return_value=fallback_response) as mock_fallback:
    ...
    @pytest.mark.asyncio
    async def test_generate_response_disabled_features(
        self, generator, mock_inference_result
    ):
