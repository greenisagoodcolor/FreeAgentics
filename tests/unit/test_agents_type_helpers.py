    ...
    def test_import_error_handling(self):
        ...
        try:
            from agents.type_helpers import (
                safe_get_agent_id, safe_get_coalition_id, ensure_string_id,
                match_agent_id, match_coalition_id, get_agent_attribute,
            ...
            pytest.skip(f"Cannot import agents.type_helpers due to dependency issues: {e}")
