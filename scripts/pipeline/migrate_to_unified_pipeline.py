...
class PipelineMigrator:
    ...
    def analyze_current_workflows(self) -> Dict[str, Any]:
        ...
        print_success(f"Analysis complete: {len(self.analysis_results['existing_workflows'])} workflows found")
    ...
    def validate_unified_pipeline(self) -> bool:
        ...
        try:
            ...
            missing_sections = [section for section in required_sections if section not in pipeline_config]
...
"""
    ...
    def execute_migration(self, force: bool = False) -> bool:
        ...
        critical_issues = [issue for issue in analysis['issues_found'] if issue['severity'] == 'high']
        if critical_issues and not force:
            print_error(f"Found {len(critical_issues)} critical issues. Use --force to proceed anyway.")
            return False
...
def main():
    ...
    parser.add_argument('--force', action='store_true',
                        help='Force migration even with critical issues')
    parser.add_argument('--analyze-only', action='store_true',
                        help='Only analyze current workflows')
    parser.add_argument('--validate-only', action='store_true',
                        help='Only validate unified pipeline')
