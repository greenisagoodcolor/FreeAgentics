...
class EdgeProcessor:
    ...
    def _extract_single_feature_type(self, edges: List[Edge], 
        ...
        feature_extractors = {
            ...
            EdgeFeatureType.DISTANCE: self._extract_distance_features,
        ...
        if extractor:
            ...
            return self._extract_custom_features(edges, feature_type.value)

    def _concatenate_features(self, feature_arrays: List[torch.Tensor]) -> torch.Tensor:
