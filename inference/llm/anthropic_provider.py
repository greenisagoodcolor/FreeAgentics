...
class AnthropicProvider(BaseProvider):
    ...
    def configure(self, credentials: ProviderCredentials, **kwargs: Any) -> bool:
        ...
        try:
            ...
            if health_result.status in [ProviderStatus.HEALTHY, ProviderStatus.DEGRADED]:
    ...
    def estimate_cost(self, input_tokens: int, output_tokens: int, model: str) -> float:
        ...
        if model not in self._model_pricing:
            ...
            pricing = self._model_pricing.get("claude-3-haiku-20240307", {"input": 0.00025, "output": 0.00125})
        else:
