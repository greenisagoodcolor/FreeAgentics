...
class ValueProposition:
    ...
    def calculate_total_value_score(self) -> float:
        ...
        metrics = [
            ...
            min(self.revenue_opportunity_usd / 1000000, 100),  # Normalize revenue (per million)
...
class MarketFitAssessment:
    ...
    def calculate_market_fit_score(self) -> float:
        ...
        market_metrics = [
            min(self.target_market_size_usd / 10000000, 100),  # Normalize to 10M baseline
...
class BusinessReadinessAssessor:
    ...
    def _determine_readiness_level(self, overall_score: float) -> BusinessReadinessLevel:
