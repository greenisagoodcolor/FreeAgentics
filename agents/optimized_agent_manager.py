...
class AdaptiveThreadPool:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "steal_efficiency": (self.stolen_tasks / max(self.completed_tasks, 1))
            * 100,
            "avg_task_time_ms": (
        ...
        stats.update(
            {
                ...
                "memory_pool": (
                    self.memory_pool.get_stats() if self.memory_pool else None
                ),
            }
        )
...
def benchmark_optimized_manager():
    ...
    try:
        ...
        observations = {
            f"agent_{i}": {"data": np.random.rand(10)} for i in range(num_agents)
        }
