...
class TradeOffer:
    ...
    def __init__(
        ...
        self.offer_id = f"trade_{offering_agent_id}_{datetime.now().timestamp()}"
        self.accepted = False
...
class Market:
    ...
    def __init__(self) -> None:
        ...
        self.market_trends: Dict[ResourceType, float] = {}  # -1 to 1, negative means declining
...
class TradingBehavior(BaseBehavior):
    ...
    def _execute_trading_strategy(
        ...
        """Execute trading strategy based on agent's personality and market conditions"""
