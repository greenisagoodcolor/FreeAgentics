...
class TradeOffer:
    ...
    def __init__(
        ...
        self.offer_id = f"trade_{offering_agent_id}_{
...
class Market:
    ...
    def __init__(self) -> None:
        ...
        # -1 to 1, negative means declining
        self.market_trends: Dict[ResourceType, float] = {}
...
class TradingBehavior(BaseBehavior):
    ...
    def _determine_wanted_resources(
        ...
        # Top 3 trending resources
        for resource_type, trend in sorted_resources[:3]:
...
class MarketAnalysisBehavior(BaseBehavior):
    ...
    def _analyze_market_patterns(
        ...
        for resource_type in ResourceType:
            market.resource_prices.get(resource_type, 1.0)
