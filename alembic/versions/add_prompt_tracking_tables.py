...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("next_suggestions", sa.JSON(), nullable=False, server_default="[]"),
    ...
    op.create_index("idx_prompts_conversation_id", "prompts", ["conversation_id"])
    ...
    op.create_table(
        ...
        sa.Column("example_prompts", sa.JSON(), nullable=False, server_default="[]"),
