...
from inference.active.gmn_parser import GMNParser  # noqa: E402
from knowledge_graph.graph_engine import (  # noqa: E402
    EdgeType,
    KnowledgeEdge,
    KnowledgeGraph,
    KnowledgeNode,
...
async def demonstrate_critical_features():
    ...
    try:
        ...
        print(
            f"✅ Created PyMDP model with {len(pymdp_model_2.get('num_states', []))} state factors"
        )
    ...
    for i, state_dim in enumerate(pymdp_model_2.get("num_states", [])):
        belief_node = KnowledgeNode(
            ...
            properties={"dimension": state_dim, "factor_type": "hidden_state"},
        )
