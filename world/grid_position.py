...
class GridCoordinate:
    ...
    def to_world_position(
        ...
        """Convert grid coordinate to world Position for integration with existing agent system"""
...
class GridPosition:
    ...
    def get_interaction_strength(self, other: "GridPosition") -> float:
        """Calculate interaction strength based on proximity (1.0 = closest, 0.0 = out of range)"""
        distance = self.coordinate.distance_to(other.coordinate)
        if distance > self.proximity_radius:
            return 0.0
