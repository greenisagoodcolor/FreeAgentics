            ...
            with self._get_session() as session:
                ...
                for entity in entities:
                    node = KnowledgeNode(
                        ...
                        source=entity.provenance.source_id if entity.provenance else conversation_id,
            ...
            with self._get_session() as session:
                ...
                for relation in relations:
                    ...
                    edge = KnowledgeEdge(
                        ...
                        confidence=relation.provenance.confidence_score if relation.provenance else 1.0,
                    )
        ...
        try:
            with self._get_session() as session:
                if hard_delete:
                    ...
                    # Then delete nodes
                    deleted = session.query(KnowledgeNode).filter(
