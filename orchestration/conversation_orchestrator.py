...
class OrchestrationResult:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "inference_metadata": self.inference_result.to_dict() if self.inference_result else None,
        }
    ...
    async def process_conversation(
        ...
        try:
            ...
            result = OrchestrationResult(
                ...
                steps_completed=[
                    step["step_name"] for step in pipeline_results["steps"]
                    if step["success"]
                ],
