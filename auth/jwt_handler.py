    ...
    def _check_key_rotation(self):
        ...
        try:
            ...
            if key_age_days > KEY_ROTATION_DAYS:
                ...
                logger.warning(f"JWT keys are {key_age_days:.0f} days old - rotation recommended soon")
        except:
            pass
    ...
    def verify_access_token(
        ...
        try:
            ...
            if fingerprint:
                ...
                if not stored_fingerprint or stored_fingerprint != self._hash_fingerprint(fingerprint):
